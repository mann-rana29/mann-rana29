...
> ### my stack
  [![My Skills](https://skillicons.dev/icons?i=py,java,html,css,js,ts,spring,fastapi,redis,postgresql,mysql,kafka,docker,git,github,postman,tailwind,next,react,idea,vscode)](https://skillicons.dev)
